...
namespace DbFirstProSolution
{
    ...
    public partial class VidzySolutionModel : DbContext
    {
        public VidzySolutionModel()
            : base("name=VidzySolutionModel")
        {
        }
        ...
        public virtual int spAddVideo(string name, Nullable<System.DateTime> releaseDate, string genre, Nullable<byte> classification)
        {
